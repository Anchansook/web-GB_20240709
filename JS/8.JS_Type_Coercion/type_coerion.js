...
/*
    문자열 타입으로 형변환
    - '+ 연산자'를 사용할 때 좌항이나 우항 중 하나라도 문자열이 존재하면 문자열이 아닌 항을 문자열로 자동 형변환
*/
console.log(1 + '1');
...
/*
    숫자 타입으로 형변환
    - '+ 연산자를 제외'한 나머지 산술 연산 혹은 대소 비교 연산에 대해서 
        좌항과 우항 중 하나라도 숫자가 존재하면 숫자가 아닌 항을 숫자로 자동 형변환
*/
console.log(1 - '1');
...
*/
if (null) console.log('is not null'); // null은 false라서 안 나옴

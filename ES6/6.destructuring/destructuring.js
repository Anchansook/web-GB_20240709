/*
    디스트럭처링 :
    - 구조화된 '배열 혹은 객체를 비구조화', 구조화를 파괴하여 '개별 변수로 할당'하는 것
...
// 초과한 범위에 해당하는 변수는 undefined가 지정됨
...
console.log(anotherFruits, othersFruits); // apple [ 'banana', 'cacao' ]

// const [...othersFruits2, anotherFruits2] = fruits; - error
...
//     birth: '1335-11-04'
// };
// 객체 디스트럭처링에서는 '변수의 순서는 상관없'지만, '이름은 반드시 객체 키의 이름과 같'아야 함
...
/*
    spread 연산자를 활용
    - 객체 디스트럭처링 마지막에 스프레드 연산자를 사용하면 '나머지 모든 속성을 묶어서 새로운 객체'를 생성
*/

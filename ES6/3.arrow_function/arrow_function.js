...
// 구현부가 한줄이면 중괄호 생략 가능, 만약에 코드가 return 작업이라면 return 키워드를 제거해야 함
func2 = (arg) => arg * arg;


// 구현부가 한줄이면서 '객체 리터럴을 반환할 때'는 함수의 코드블럭을 제거하면 '객체 리터럴을 소괄호로 묶어야 함'
func2 = (name, tombName) => {
...
numbers.forEach(forEachArg); // 콜백 함수 사용 시 권장
